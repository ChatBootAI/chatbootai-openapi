...
@org.eclipse.microprofile.openapi.annotations.media.Schema(description="Represents the chat response returned by the model, based on the provided chat request.")
...
public class ChatResponse   {
  ...
  @org.eclipse.microprofile.openapi.annotations.media.Schema(description = "A unique identifier for the completion.")
  @JsonProperty("id")
  public String getId() {
    return id;
  }
  ...
  @org.eclipse.microprofile.openapi.annotations.media.Schema(required = true, description = "A list of chat completion choices. Can be more than one.")
  ...
  @org.eclipse.microprofile.openapi.annotations.media.Schema(required = true, description = "The object type, which is always \"chat\"")
  @JsonProperty("object")
  ...
  @org.eclipse.microprofile.openapi.annotations.media.Schema(description = "The Unix timestamp (in seconds) of when the completion was created.")
  ...
  @org.eclipse.microprofile.openapi.annotations.media.Schema(description = "The model used for the chat completion.")
  @JsonProperty("model")
